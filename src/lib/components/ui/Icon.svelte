<script lang="ts">
  import {
    ...
    FunnelIcon,
    SortAscendingIcon,
    SortDescendingIcon, DotsThreeVerticalIcon, StarIcon, ArchiveIcon
  } from "phosphor-svelte";
  import type { IconWeight } from "phosphor-svelte";

  export let name: "grid" | "list" | "box" | "deck" | "settings" | "search" | "plus" | "trash" | "x" | "upload" | "download" | "chevronDown" | "filter" | "arrowUpDown" | "sparkles" | "pencil" | "minus" | "check" | "circle" | "astroid" | "sort-asc" | "sort-desc" | "dots-three-vertical" | "star" | "archive" = "grid";
  export let size = 16;
